...
TRANSLATIONS = {
    "en": {
        ...
        "picker_title_src": "📥 <b>Select Source Chats</b>\n\nTap chats below to select (max {limit}). You can also FORWARD any message from the desired chat here, or type its @username / t.me link.\n\n💡 Tip: Pin a chat in Telegram so it appears at the top of this list.",
        ...
        "settings_cat_delay": "⏳ <b>Delay Timer</b>\n\nCurrent: <b>{current}</b>\n\nPick a preset:",
        "antiban_title": "🛡️ <b>Anti-Ban Speed</b>\n\nCurrent: <b>{current}</b>\n\nPick a preset:",
        "preset_off": "⭕ Off",
        "preset_slow": "🐢 Slow",
        "preset_normal": "⚡ Normal",
        "preset_fast": "🚀 Fast",
        "preset_saved": "✅ {feature} set to <b>{value}</b>.",
        ...
        "upload_success": "✅ File stored: <b>{name}</b> ({size})\n\nEnable it from Settings → Forwarding Controls:\n• 📎 Attach File to Every Message\n• 🔁 Replace Same-Type Files",
    ...
    "hinglish": {
        ...
        "picker_title_src": "📥 <b>Source Chats Chuno</b>\n\nNeeche chats par tap karke select karo (max {limit}). Aap desired chat se koi message FORWARD bhi kar sakte ho, ya @username / t.me link type kar sakte ho.\n\n💡 Tip: Telegram me chat ko pin karo taaki wo list me sabse upar dikhe.",
        ...
        "preset_normal": "⚡ Normal",
        "preset_fast": "🚀 Fast",
        "preset_saved": "✅ {feature} ab <b>{value}</b> hai.",
        ...
        "upload_success": "✅ File store ho gayi: <b>{name}</b> ({size})\n\nSettings → Forwarding Controls me on karo:\n• 📎 Har Message Me File Attach\n• 🔁 Same-Type Files Replace",
