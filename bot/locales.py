...
TRANSLATIONS = {
    "en": {
        ...
        "stars_invoice_desc": "DealsKoti Auto Forwarder — {plan} plan for {days} days. Activates instantly after payment.",
    ...
    "hinglish": {
        ...
        "stars_invoice_title": "{plan} {cycle}",
        "stars_invoice_desc": "DealsKoti Auto Forwarder — {plan} plan, {days} din ke liye. Payment ke turant baad activate.",
