...
TRANSLATIONS = {
    "en": {
        ...
        "qr_instructions": "📷 <b>Login with QR Code</b>\n\n<b>On another device</b> (laptop, second phone):\nTelegram → Settings → Devices → <b>Link Desktop Device</b> → scan the code above.\n\n<b>Only have this phone?</b>\nTap <b>⚡ Tap to Login</b> below — no camera needed.\n\n🔐 Your session is encrypted. You can disconnect any time with /disconnect.\n\n⏳ QR expires in: <b>{seconds}s</b>",
        "qr_timer": "⏳ Waiting for you to scan…  <b>{seconds}s</b>",
        "qr_expired": "⏰ <b>QR Code Expired</b>\n\nNobody scanned it in time, so it has been cancelled for safety.\n\nNothing went wrong — just generate a new one, or use your phone number instead.",
    ...
    "hinglish": {
        ...
        "qr_instructions": "📷 <b>QR Code se Login</b>\n\n<b>Doosre device par</b> (laptop, doosra phone):\nTelegram → Settings → Devices → <b>Link Desktop Device</b> → upar wala code scan kijiye.\n\n<b>Sirf yahi phone hai?</b>\nNeeche <b>⚡ Tap to Login</b> dabaiye — camera ki zarurat nahi.\n\n🔐 Aapka session encrypted hai. /disconnect se kabhi bhi hata sakte hain.\n\n⏳ QR expire hoga: <b>{seconds}s</b>",
        "qr_timer": "⏳ Scan ka intezaar hai…  <b>{seconds}s</b>",
        "qr_expired": "⏰ <b>QR Code Expire Ho Gaya</b>\n\nSamay par kisi ne scan nahi kiya, isliye suraksha ke liye ise band kar diya gaya.\n\nKuch galat nahi hua — bas naya QR bana lijiye, ya phone number se login kijiye.",
