...
TRANSLATIONS = {
    "en": {
        ...
        "replace_file_prompt": "📎 <b>Replace File</b>\n\nWhen ON, if a forwarded post contains a document with the <b>same extension</b> as your uploaded file, your file is sent instead — the caption stays exactly as it was.\n\n<b>Example</b>\nSource: \"Download my new app\" + <code>theirapp.apk</code>\nYours:  \"Download my new app\" + <code>yourapp.apk</code>\n\n✅ Posts with no document are untouched\n✅ A different extension is left alone\n❌ Photos and videos are never replaced\n\n📤 Upload your file first with /upload_file\n\n⚠️ One file per account — it is used by all your tasks.",
    ...
    "hinglish": {
        ...
        "replace_file_prompt": "📎 <b>Replace File</b>\n\nON hone par, agar forward hone wali post me <b>same extension</b> ka document ho jo aapki upload ki hui file ka hai, to aapki file bhej di jayegi — caption bilkul waisa hi rahega.\n\n<b>Example</b>\nSource: \"Download my new app\" + <code>theirapp.apk</code>\nAapka:  \"Download my new app\" + <code>yourapp.apk</code>\n\n✅ Jis post me document nahi, wo waisi hi rahegi\n✅ Doosri extension ko chhua nahi jayega\n❌ Photo aur video kabhi replace nahi honge\n\n📤 Pehle /upload_file se apni file upload karein\n\n⚠️ Ek account, ek file — wo aapke saare tasks me use hoti hai.",
        "stars_invoice_title": "{plan} {cycle}",
